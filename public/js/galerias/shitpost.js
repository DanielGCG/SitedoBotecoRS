...
async function carregarImagensFirebase() {
    const galeriaRef = ref(storage, 'galeria/shitpost');
...
async function uploadFile() {
    ...
    const imagePath = `galeria/shitpost/${imageName}`;
...
async function editarNomeObra(nomeAtual, url) {
    ...
    try {
        ...
        const novaImagemRef = ref(storage, `galeria/shitpost/${novoNome}.png`);
        const imagemAntigaRef = ref(storage, `galeria/shitpost/${nomeAtual}.png`);

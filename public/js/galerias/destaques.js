...
async function carregarImagensFirebase() {
    const galeriaRef = ref(storage, 'galeria/destaques');
...
async function uploadFile() {
    ...
    const imagePath = `galeria/destaques/${imageName}`;
...
async function removerObraNoFirebase(nomeObra) {
    try {
        ...
        const obraRef = ref(storage, `galeria/destaques/${nomeObra}.png`);
...
async function editarNomeObra(nomeAtual, url) {
    ...
    try {
        ...
        const novaImagemRef = ref(storage, `galeria/destaques/${novoNome}.png`);
        const imagemAntigaRef = ref(storage, `galeria/destaques/${nomeAtual}.png`);
